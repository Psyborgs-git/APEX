...
impl Metrics {
    pub fn new() -> Self {
        ...
        .unwrap();
        let quote_cache_size =
            IntGauge::new("apex_quote_cache_size", "Current size of the quote cache").unwrap();
        ...
        .unwrap();
        let orders_filled =
            IntCounter::new("apex_orders_filled_total", "Total number of orders filled").unwrap();
        ...
        .unwrap();
        let position_count =
            IntGauge::new("apex_position_count", "Current number of open positions").unwrap();
        ...
        // System metrics
        let active_adapters =
            IntGauge::new("apex_active_adapters", "Number of active adapters").unwrap();
        let active_strategies =
            IntGauge::new("apex_active_strategies", "Number of active strategies").unwrap();
        ...
        registry
            .register(Box::new(quote_cache_size.clone()))
            .unwrap();
        ...
        registry
            .register(Box::new(ticks_write_errors.clone()))
            .unwrap();
        registry
            .register(Box::new(storage_latency.clone()))
            .unwrap();
        registry
            .register(Box::new(active_adapters.clone()))
            .unwrap();
        registry
            .register(Box::new(active_strategies.clone()))
            .unwrap();
